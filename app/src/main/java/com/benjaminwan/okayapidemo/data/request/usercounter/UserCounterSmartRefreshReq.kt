...
import com.benjaminwan.okayapidemo.common.APP_USER_COUNTER_SMARTREFRESH
import com.benjaminwan.okayapidemo.common.CounterTpye
import com.benjaminwan.okayapidemo.common.sign

data class UserCounterSmartRefreshReq(
        val uuid: String,
        val token: String,
        val type: CounterTpye,
        val name: String,
        val value: String,
        val s: String = APP_USER_COUNTER_SMARTREFRESH,
